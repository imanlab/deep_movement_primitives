...
class Experiment02(Experiment):
    ...
    def __init__(self, cfg: Config):
        ...
        # Manually defined test samples for each regions.
        self.idx_test = {
...
if __name__ == "__main__":
    ...
    parser = ExperimentArgumentParser("Experiment CNN RTP-RGB: CNN model predicting full ProMP weights of RTP using the RTP-RGB dataset.")
    args = parser.parse_args()

    cfg = ConfigExp(args.name)
    exp = Experiment02(cfg)
