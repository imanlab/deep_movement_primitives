...
class Experiment17(Experiment):
    ...
    Dataset: WPP-RGB (Palpation paths: training/validation: 1, 2, 5; mixed training/validation and testing: 3, 4; excluded: 6, 7)
...
if __name__ == "__main__":
    ...
    parser = ExperimentArgumentParser("Experiment CNN WPP-RGB (Ablation 1): CNN model predicting full ProMP weights of WPP using the WPP-RGB dataset."
                                      "Palpation paths: training/validation: 1, 2, 5; mixed training/validation and testing: 3, 4; excluded: 6, 7")
