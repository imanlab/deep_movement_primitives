...
class Experiment04(Experiment):
    ...
    Metrics:
    - MSE and RMSE on trajectory in joint space.
...
if __name__ == "__main__":
    ...
    parser = ExperimentArgumentParser("Experiment CNN RTP-RGBD: CNN model predicting full ProMP weights of RTP using the RTP-RGBD dataset.")
