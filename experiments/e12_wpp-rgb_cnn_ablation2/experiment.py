...
class Experiment12(Experiment):
    ...
    Dataset: WPP-RGB (Palpation paths: testing 3, 4; training/validation: 1, 2, 5, 6, 7)
...
if __name__ == "__main__":
    ...
    parser = ExperimentArgumentParser("Experiment CNN WPP-RGB (Ablation 1): CNN model predicting full ProMP weights of WPP using the WPP-RGB dataset."
                                      "Palpation paths: testing: 3, 4; training/validation: 1, 2, 5, 6, 7")
    args = parser.parse_args()

    cfg = ConfigExp(args.name)
    exp = Experiment12(cfg)
